...
export default function SignUpForm() { 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
      ...
      // Attempt login
    const result = await register({ first_name, last_name, email, username, password } as RegisterRequest)
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      {showPassword ? (
                        <span className="fill-gray-500 dark:fill-gray-400"><EyeIcon /></span>
                      ) : (
                        <span className="fill-gray-500 dark:fill-gray-400"><EyeCloseIcon /></span>
                      )}
                    </span>
                  </div>
                </div>
